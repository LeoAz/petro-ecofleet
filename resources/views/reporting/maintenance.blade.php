                ...
                @if( ! empty($repairs))
                    <table class="datatable-init-export nk-tb-list nk-tb-ulist" data-auto-responsive="false">
                        ...
                        <tr class="nk-tb-item nk-tb-head">
                            ...
                            <th class="nk-tb-col"><span class="sub-text">Citerne</span></th>
                            <th class="nk-tb-col"><span class="sub-text">Montant</span></th>
                            <th class="nk-tb-col"><span class="sub-text">Montant Piece</span></th>
                        ...
                        @foreach( $repairs as $repair )
                            <tr class="nk-tb-item">
                                ...
                                <td class="nk-tb-col tb-col-md">
                                    <span>{{ $repair->vehicle->activeTrailer ? $repair->vehicle->activeTrailer->trailer->registration : '-' }}</span>
                                </td>
                                <td class="nk-tb-col tb-col-md">
                                    {{ number_format($repair->amount, 0,',', ' ') }}
                                </td>
                                <td class="nk-tb-col tb-col-md">
                                    {{ number_format($repair->total_amount - $repair->amount, 0, ' ', ' ') }}
                                </td>
                                <td class="nk-tb-col tb-col-md">
