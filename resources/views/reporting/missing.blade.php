                        ...
                        @foreach( $unloads as $folder )
                            <tr>
                                ...
                                <td class="nk-tb-col tb-col-md text-dark">
                                    <span>{{ $folder->trip->date->format('d/m/Y') }}</span>
                                </td>
                                <td class="nk-tb-col tb-col-md text-dark">
                                    <span>{{ $folder->trip->vehicle ? $folder->trip->vehicle->registration : '' }}</span>
                                </td>
                                <td class="nk-tb-col tb-col-md text-dark">
                                    <span>{{ $folder->trip->vehicle ? $folder->trip->vehicle?->activeDriver?->name : '' }}</span>
                                </td>
                                <td class="nk-tb-col tb-col-md text-dark">
                                    {{ $folder->trip->start_point }} - {{ $folder->trip->end_point }}
                                </td>
                                <td class="nk-tb-col tb-col-md">
                                    <span>{{ $folder->date->format('d/m/Y') }}</span><br />
                                    <span>quantité: {{ $folder->unload_qty  }}</span>
                                </td>
                                <td class="nk-tb-col tb-col-md">
                                    <span>{{ $folder->product->name }}</span>
                                </td>
                                <td class="nk-tb-col tb-col-md">
