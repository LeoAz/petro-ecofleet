        ...
        <div class="nk-sidebar-menu" data-simplebar>
            <ul class="nk-menu">
                ...
                <li class="nk-menu-item">
                    <a href="{{ route('maintenance.setting.motif.index') }}" class="nk-menu-link">
                        <span class="nk-menu-icon"><em class="icon ni ni-question"></em></span>
                        <span class="nk-menu-text">Motif de reparation</span>
                    </a>
                </li><!-- .nk-menu-item -->
                <li class="nk-menu-item">
                    <a href="{{ route('maintenance.setting.category.index') }}" class="nk-menu-link">
                        <span class="nk-menu-icon"><em class="icon ni ni-setting"></em></span>
                        <span class="nk-menu-text">Categories pièces</span>
                    </a>
                </li><!-- .nk-menu-item -->
            </ul><!-- .nk-menu -->
        </div><!-- .nk-sidebar-menu -->
