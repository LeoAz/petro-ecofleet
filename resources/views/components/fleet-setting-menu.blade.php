        ...
        <div class="nk-sidebar-menu" data-simplebar>
            <ul class="nk-menu">
                ...
                <li class="nk-menu-item">
                    <a href="{{ route('fleet.setting.brand.index') }}" class="nk-menu-link">
                        <span class="nk-menu-icon"><em class="icon ni ni-tag"></em></span>
                        <span class="nk-menu-text">Marque</span>
                    </a>
                </li><!-- .nk-menu-item -->
                <li class="nk-menu-item">
                    <a href="{{ route('fleet.setting.pattern.index') }}" class="nk-menu-link">
