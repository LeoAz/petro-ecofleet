            ...
            <div class="nk-block-between">
                <div class="nk-block-head-content">
                    <h5 class="nk-block-title">
                        ...
                        Liste des documents du véhicule - {{ $driver->name }}
                    </h5>
                    <div class="nk-block-des text-soft">
                        <p>Ci-dessous un listing de l'ensemble des documents du véhicule - {{ $driver->name }} dans la base de donnée</p>
                    </div>
                </div>
        ...
        <div class="card">
            <div class="card-inner">
                <table class="datatable-init nk-tb-list nk-tb-ulist" data-auto-responsive="false">
                    ...
                    <tbody>
                    @foreach( $driver->documents->sortByDesc('created_at') as $docs )
                        <tr class="nk-tb-item">
