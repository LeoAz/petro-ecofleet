            ...
            <div class="nk-block-between">
                <div class="nk-block-head-content">
                    ...
                    <div class="nk-block-des text-soft">
                        <p>Ci-dessous un listing de l'ensemble des véhicules possédant des documents dans la base de donnée</p>
                    </div>
                </div>
                    ...
                    @foreach( $vehicles as $vehicle )
                        <tr class="nk-tb-item">
                            ...
                            <td class="nk-tb-col">
                                <div class="user-card">
                                    <div class="user-info">
                                        <span class="tb-lead">{{ $vehicle->registration }} <span class="dot dot-success d-md-none ml-1"></span></span>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="nk-tb-col tb-col-md">
                                <span class="badge badge-pill badge-dim badge-primary">{{ $vehicle->documents->count() }}</span>
                            </td>
                            <td class="nk-tb-col tb-col-md">
                                <span class="badge badge-pill badge-dim badge-success">
                                    {{ $vehicle->documents->where('status', \App\Enums\Fleet\DocumentStatus::Active)->count() }}
                                </span>
                            </td>
                            <td class="nk-tb-col tb-col-md">
                                <span class="badge badge-pill badge-dim badge-danger">
                                     {{ $vehicle->documents->where('status', \App\Enums\Fleet\DocumentStatus::Expired)->count() }}
                                </span>
                            </td>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <ul class="link-list-opt no-bdr">
                                                    <li>
                                                        <a href="{{ route('docs.vehs.document', $vehicle->uuid) }}">
        ...
        <div class="modal-dialog modal-dialog-top modal-xl" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="form-create" action="{{ route('docs.vehs.store') }}" method="post">
                        @csrf
