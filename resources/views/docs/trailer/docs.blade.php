            ...
            <div class="nk-block-between">
                <div class="nk-block-head-content">
                    <h5 class="nk-block-title">
                        ...
                        Liste des documents de la remorque - {{ $trailer->registration }}
                    </h5>
                    <div class="nk-block-des text-soft">
                        <p>Ci-dessous un listing de l'ensemble des documents de la remorque - {{ $trailer->registration }} dans la base de donnée</p>
                    </div>
                </div>
        ...
        <div class="card">
            <div class="card-inner">
                <table class="datatable-init nk-tb-list nk-tb-ulist" data-auto-responsive="false">
                    ...
                    <tbody>
                    @foreach( $trailer->documents->sortByDesc('created_at') as $docs )
                        <tr class="nk-tb-item">
                                                ...
                                                <ul class="link-list-opt no-bdr">
                                                    <li>
                                                        ...
                                                        <form id="sale-delete-form{{ $docs->id }}"
                                                              action="{{ route('docs.trailers.delete', $docs->uuid) }}" method="post" style="display: none;"
                                                        >
                                                            @csrf
                                                            @method('DELETE')
                                                        </form>
