            ...
            <div class="nk-block-head-content">
                ...
                <div class="nk-block-des text-soft">
                    <ul class="list-inline">
                        <li>Crée le : <span class="text-base">{{ $exit->date->format('d/m/Y') }}</span></li>
                    </ul>
                </div>
            </div>
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-left">
                        <ul class="link-list-plain sm">
                            <li>
                                <a href="{{ route('maintenance.warehouse.exit.print', $exit->uuid) }}" target="_blank">
                            ...
                            <li>
                               ...
                               document.getElementById('folder-opened-form').submit();"
                                ...
                                <form id="folder-opened-form"
                                      action="{{ route('maintenance.warehouse.exit.opened', $exit->uuid) }}" method="post" style="display: none;"
                                >
                                    <input type="hidden" name="status_exit" value="{{ \App\Enums\Maintenance\ExitVoucherStatus::Opened }}">
                                    @csrf
                                    @method('PUT')
                                </form>
                            </li>
                            <li>
                               ...
                               document.getElementById('folder-closed-form').submit();"
                                ...
                                <form id="folder-closed-form"
                                      action="{{ route('maintenance.warehouse.exit.validated', $exit->uuid) }}" method="post" style="display: none;"
                                >
                                    <input type="hidden" name="status_exit" value="{{ \App\Enums\Maintenance\ExitVoucherStatus::Validated }}">
                                    @csrf
                                    @method('PUT')
                                </form>
                            </li>
    ...
    <div class="card shadow-sm mt-3">
        <div class="nk-tb-list">
            <div class="nk-tb-item nk-tb-head">
                ...
                <div class="nk-tb-col tb-col-lg"><span>N° Serie</span></div>
                    ...
                    <div class="nk-tb-col">
                        <div class="tb-odr-btns d-none d-sm-inline">
                                ...
                                <form id="detail-delete-form{{ $detail->id }}"
                                      action="{{ route('maintenance.warehouse.exit.part.delete', $detail->id) }}" method="post" style="display: none;"
                                >
                                    @csrf
                                    @method('DELETE')
                                </form>
            ...
            <div class="modal-dialog modal-dialog-top modal-xl" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="form-create" action="{{ route('maintenance.warehouse.exit.part.store', $exit->uuid) }}" method="post">
                            @csrf
                            <div class="preview-block">
                                <div class="row gy-4">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label class="form-label" for="default-01">N° de serie</label>
                                            <div class="form-control-wrap">
                                                <input name="reference" type="text" class="form-control @error('reference') error @enderror" id="default-01" placeholder="La reference" value="{{ old('reference') }}">
                                                @error('reference')
