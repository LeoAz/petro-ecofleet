            ...
            <div class="nk-block-between">
                <div class="nk-block-head-content">
                    ...
                    <div class="nk-block-des text-soft">
                        <p>Ci-dessous un listing de l'ensemble bon de commande disponible dans la base de donnée</p>
                    </div>
                </div>
                <div class="nk-block-head-content">
            ...
            <div class="card-inner">
                <table class="datatable-init nk-tb-list nk-tb-ulist" data-auto-responsive="false">
                    ...
                    <tr class="nk-tb-item nk-tb-head">
                        ...
                        <th class="nk-tb-col"><span class="sub-text">N° bon commande</span></th>
                    ...
                    @foreach( $orders as $order )
                        <tr class="nk-tb-item">
                            ...
                            <td class="nk-tb-col tb-col-md">
                                <span> {{ $order->vehicle->registration ?? '-' }}</span>
                            </td>
                            <td class="nk-tb-col tb-col-md">
                               @include('layout.partials.enum.maintenance.OrderStatus', ['status' => $order->status])
                            </td>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-left">
                                                <ul class="link-list-plain sm">
                                                    <li>
                                                        <a href="{{ route('maintenance.warehouse.order.detail', $order->uuid) }}">
                                                            <em class="icon ni ni-file-text"></em>
                                                            <span>Details</span>
                                                        </a></li>
                                                    <li>
                                                    ...
                                                    <li>
                                                        <a href="#"
                                                           onclick="event.preventDefault();
                                                               document.getElementById('sale-delete-form{{ $order->id }}').submit();"
                                                        >
                                                            <em class="icon ni ni-cross-circle text-danger"></em>
                                                            <span class="text-danger">Supprimer</span>
                                                        </a>
                                                        <form id="sale-delete-form{{ $order->id }}"
        ...
        <div class="modal-dialog modal-dialog-top modal-xl" role="document">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title">Saisir un nouveau bon de commande</h5>
                </div>
                <div class="modal-body">
                    <form id="form-create" action="{{ route('maintenance.warehouse.order.store') }}" method="post">
                        @csrf
                        <div class="preview-block">
                            <div class="row gy-4">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap" data-placeholder = "selectioner le fournisseur">
                                            <select  name="provider_id" class="form-select @error('provider_id') error @enderror" id="default-03">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label class="form-label" for="default-09">Véhicule</label>
                                        <div class="form-control-wrap" data-placeholder = "selectioner le véhicule">
                                            <select  name="vehicle_id" class="form-select @error('vehicle_id') error @enderror" id="default-09" data-search="on">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <input name="description" type="text" class="form-control @error('description') error @enderror" id="default-01" placeholder="description du bon" value="{{ old('description')}}">
                                            @error('description')
                                            <span class="invalid">{{ $message }}</span>
                                            @enderror
                                        </div>
