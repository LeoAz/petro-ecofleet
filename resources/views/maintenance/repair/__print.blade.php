...
<head>
    ...
    <!-- Page Title  -->
    <title>Fiche de reparation N° {{ $repair->code }} | Ecofleet </title>
    <!-- StyleSheets  -->
            ...
            <div class="invoice-wrap">
                <div>
                    <div class="text-right mb-5 h-25 w-200">
                        {!! QrCode::size(100)->generate( $repair->uuid); !!}
                    </div>
                    ...
                    <div class="text-center text-uppercase fs-22px fw-bold ff-mono">
                        <ins><p class="mb-5">Fiche de réparation N°: {{ $repair->code }}</p></ins>
                    </div>
                                ...
                                <div class="card-inner">
                                    <div class="nk-block">
                                        <div class="profile-ud-list">
                                            ...
                                            <div class="profile-ud-item">
                                                <div class="profile-ud wider">
                                                    <span class="profile-ud-label">Le Kilométrage</span>
                                                    <span class="profile-ud-value">
                                            ...
                                            <div class="profile-ud-item">
                                                <div class="profile-ud wider">
                                                    <span class="profile-ud-label">Description de la reparation</span>
                                                    <span class="profile-ud-value">
                                                        {{ $repair->description }}
                                                    </span>
                                                </div>
