    ...
    <div class="nk-block nk-block-lg">
        ...
        <div class="card shadow-sm">
            <div class="card-inner">
                <form id="form-create" action="{{ route('maintenance.garage.store', $vehicle->uuid) }}" method="post">
                    @csrf
                        ...
                        <div class="row gy-4">
                            ...
                            <div class="col-sm-8">
                                <div class="form-group">
                                    ...
                                    <div class="form-control-wrap">
                                        <input name="reason" type="text" class="form-control @error('reason') error @enderror" id="default-01" placeholder="Raison de la mise au garage" value="{{ old('reason') }}">
                                        @error('reason')
                                        <span class="invalid">{{ $message }}</span>
                                        @enderror
                                    </div>
