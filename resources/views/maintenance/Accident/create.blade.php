    ...
    <div class="nk-block nk-block-lg">
        ...
        <div class="card shadow-sm">
            <div class="card-inner">
                <form id="form-create" action="{{ route('maintenance.accident.store', $vehicle->uuid) }}" method="post">
                    @csrf
                        ...
                        <div class="row gy-4">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <div class="form-control-wrap">
                                        <input name="place" type="text" class="form-control @error('place') error @enderror" id="default-01" placeholder="Le montant" value="{{ old('place') }}">
                                        @error('place')
                                        <span class="invalid">{{ $message }}</span>
                                        @enderror
                                    </div>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <div class="form-control-wrap">
                                        <input name="description" type="text" class="form-control @error('description') error @enderror" id="default-01" placeholder="Description de l'accident" value="{{ old('description') }}">
                                        @error('description')
                                        <span class="invalid">{{ $message }}</span>
                                        @enderror
                                    </div>
