...
<head>
    ...
    <!-- Page Title  -->
    <title>Fiche de maintenance N° {{ $maintenance->code }} | Ecofleet </title>
    <!-- StyleSheets  -->
            ...
            <div class="invoice-wrap">
                <div>
                    <div class="text-right mb-5 h-25 w-200">
                        {!! QrCode::size(100)->generate( $maintenance->uuid); !!}
                    </div>
                    ...
                    <div class="text-center text-uppercase fs-22px fw-bold ff-mono">
                        <ins><p class="mb-5">Fiche de maintenance N°: {{ $maintenance->code }}</p></ins>
                    </div>
