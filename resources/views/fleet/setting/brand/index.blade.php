            ...
            <div class="nk-block-between">
                <div class="nk-block-head-content">
                    ...
                    <div class="nk-block-des text-soft">
                        <p>Ci-dessous un listing de l'ensemble des marques dans la base de donnée</p>
                    </div>
                </div>
                    ...
                    @foreach($brands as $band)
                        <tr class="nk-tb-item">
                            <td class="nk-tb-col nk-tb-col-check">
                                <div class="custom-control custom-control-sm custom-checkbox notext">
                                    <input type="checkbox" class="custom-control-input" id="{{ $band->id }}">
                                    <label class="custom-control-label" for="{{ $band->id }}"></label>
                                </div>
                            </td>
                            <td class="nk-tb-col">
                                <div class="user-card">
        ...
        <div class="modal-dialog modal-dialog-top modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title">Saisir une nouvelle marque</h5>
                </div>
                <div class="modal-body">
                    <form id="form-create" action="{{ route('fleet.setting.brand.store') }}" method="post">
                        @csrf
                        <div class="preview-block">
                            <div class="row gy-4">
                                <div class="col-sm-8">
                                    <div class="form-group">
                                        <label class="form-label" for="default-01">Nom de la marque</label>
                    ...
                    <form id="form-edit" method="post">
                        ...
                        <div class="preview-block">
                            <div class="row gy-4">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label class="form-label" for="default-01">Le nom de la marque</label>
                                        <div class="form-control-wrap">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('a[data-target$=edit-state]').on('click', function(){
                $.ajax({
                    method: "GET",
                    url: "{{ route('fleet.setting.brand.edit', ['brand' => '#'])  }}".replace('#', $(this).attr('data-resource')),
                    dataType: 'json',
                    success: function(brand){
                        form.attr('action', '{{ route('fleet.setting.brand.update', ['brand' => '#']) }}'
                            .replace('#', brand.id));
                        $('#edit-state [name=name]').attr('value', brand.name);
                    },
                })
            });
