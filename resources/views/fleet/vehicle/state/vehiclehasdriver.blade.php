            ...
            <div class="nk-block-between">
                <div class="nk-block-head-content">
                    <h5 class="nk-block-title">
                        ...
                        Liste des vehicules avec chauffeurs
                    </h5>
                    <div class="nk-block-des text-soft">
                        <p>Ci-dessous un listing de l'ensemble des vehicules avec chauffeurs disponible dans la base de donnée</p>
                    </div>
                </div>
                        ...
                        <tr class="nk-tb-item">
                            ...
                            <td class="nk-tb-col tb-col-md">
                                @if( $vehicle->has_driver )
                                    <span>
                                        {{ $vehicle->activeDriver ? $vehicle->activeDriver->driver->name : '-'}}
                                    </span>
                                @else
                                    <span>
