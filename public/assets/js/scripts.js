  ...
  NioApp.DataTable = function (elm, opt) {
    if ($(elm).exists()) {
      $(elm).each(function () {
        ...
        var export_title = $(this).data('export-title') ? $(this).data('export-title') : 'Exporter';
        ...
        var def = {
          ...
          language: {
            ...
            lengthMenu: "<span class='d-none d-sm-inline-block'>Voir</span><div class='form-control-select'> _MENU_ </div>",
            info: "_START_ -_END_ sur _TOTAL_",
            infoEmpty: "Pas de donnée trouver",
